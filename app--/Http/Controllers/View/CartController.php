...
//print_r($data);exit();
    ...
    public static function SendMail($order_id, $order =''){
        ...
        $to .=',gabit@trustylabs.kz,nadya_0910@mail.ru,info@happypizza.kz';
...
//            //dump($cart);
            ...
            3. Все акции могут проходить щодновременно, если есть соответствующие товары в корзине.
            4. Товары-конструкторы не учавстыуют в акции.
